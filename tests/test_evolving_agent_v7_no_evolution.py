#!/usr/bin/env python3
"""
Self-Evolving Agent V7 (No Evolution) - 消融实验：无心智地图演化

核心设计：
1. 与 V7 完全相同，但 **禁用** 心智地图演化
2. 用于对比演化机制的效果
3. 保留校准机制，仅禁用演化
4. 与 V7 结果对比，分析演化的贡献
...
def main():
    parser = argparse.ArgumentParser(description='Self-Evolving Agent V7 (No Evolution) - Ablation Study')
    ...
    # 打印结果
    print("\n" + "=" * 100)
    print("V7 无演化版本 (消融实验: 禁用心智地图演化) - 测试结果")
    print("=" * 100)
    ...
    output_dir = Path(args.output_dir) / f"evolving_agent_v7_no_evo_{timestamp}"
